...
import 'package:kelena/widgets/instructor/dialogDeleteTeacherSubject.dart';
import 'package:kelena/widgets/student/dialogAddLecture.dart';
import 'package:intl/intl.dart';

class DialogEditTeacherSubject extends StatefulWidget {
  final bool addBool;
  ...
  final String userId;
  const DialogEditTeacherSubject({
    Key key,
    this.addBool,
    this.startTime,
    this.endTime,
  ...
  @override
  _DialogEditTeacherSubjectState createState() =>
      new _DialogEditTeacherSubjectState();
}

class _DialogEditTeacherSubjectState extends State<DialogEditTeacherSubject> {
  @override
                    ...
                    child: IconButton(
                      ...
                      onPressed: () {
                        showDialog(
                            context: context,
                            builder: (context) {
                              return DialogDeleteTeacherSubject(
                                lectureId: widget.lectureId,
                                userId: widget.userId,
                              );
                            });
